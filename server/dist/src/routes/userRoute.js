...
import { changeUserPassword, emailVerification, getNewAccessToken, getUserProfile, resendRegisterVerificationOtp, sendResetPasswordLink, userLogin, userLogout, userPasswordReset, userRegistraion, } from "../controllers/userController.js";
...
//protected routes
router.get("/get-profile", accessTokenAutoRefresh, passport.authenticate("jwt", { session: false }), getUserProfile);
